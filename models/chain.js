...
const models = require('./AuditLogChainSchema');
...
exports.AuditLogBlockchain = class AuditLogBlockchain {
    ...
    async createGenesisBlock() {
       ...
       // let user="Patient1"
        let newblockInfo = new Block(id, null, new Date().getTime(),null);
    ...
    async getGenesisBlock() {
        // let blockInfo = await models.AuditLogChain.find({data:'Patient12'}).sort({ $natural: 1}).limit(1);
